...
if (!VK.xdConnectionCallbacks) {
  ...
  VK.extend(VK, {
    ...
    _path: {
      login: 'authorize',
      proxy: 'http://vk.com/js/api/fxdm_oauth_proxy.html'
    },
      ...
      call: function(method, params, cb, queryTry) {
        ...
        if (useXDM) {
          if (VK.xdReady) {
            ...
            VK.Observer.subscribe('http://vk.com/js/api/xdm.init', function() {
              VK.XDM.remote.callMethod('apiCall', method, qs, responseCb);
            });
            VK.XDM.init();
          }
  ...
  VK.XDM = {
    ...
    init: function() {
      ...
      this.remote = new fastXDM.Server({
        onInit: function() {
          VK.xdReady = true;
          VK.Observer.publish('http://vk.com/js/api/xdm.init');
        }
      });
...
if (!VK.Widgets) {
  ...
  VK.Widgets.Comments = function(objId, options, page) {
    ...
    if (!VK._apiId) throw Error('http://vk.com/js/api/VK not initialized. Please use VK.init');
    options = options || {};
    ...
    return VK.Widgets._constructor('http://vk.com/js/api/widget_comments.php', objId, options, params, {
  ...
  VK.Widgets.Recommended = function(objId, options) {
    ...
    return VK.Widgets._constructor('http://vk.com/js/api/widget_recommended.php', objId, options, params, {}, {
  ...
  VK.Widgets.Post = function(objId, ownerId, postId, hash, options) {
    ...
    return VK.Widgets._constructor('http://vk.com/js/api/widget_post.php', objId, options, params, {
      showBox: function(url, props) {
        var box = VK.Util.Box(VK.Widgets.showBoxUrl(options.base_domain, url), [], {
          proxy: function() {
            rpc.callMethod.apply(rpc, arguments);
  ...
  VK.Widgets.Like = (function(Like) {
    ...
    Like = function(objId, options, page) {
      ...
      var widgetId = VK.Widgets._constructor('http://vk.com/js/api/widget_like.php', objId, options, params, {
  ...
  VK.Widgets.Poll = function(objId, options, pollId) {
    ...
    return VK.Widgets._constructor('http://vk.com/js/api/al_widget_poll.php', objId, options, params, {}, {
      startHeight: 144,
      minWidth: 300
    });
  };
  ...
  VK.Widgets.Community = VK.Widgets.Group = function(objId, options, gid) {
    ...
    return VK.Widgets._constructor('http://vk.com/js/api/widget_community.php', objId, options, params, {
      showBox: function(url, props) {
        var box = VK.Util.Box(VK.Widgets.showBoxUrl(options.base_domain, url), [], {
          proxy: function() {
            rpc.callMethod.apply(rpc, arguments);
  ...
  VK.Widgets.Auth = function(objId, options) {
    ...
    return VK.Widgets._constructor('http://vk.com/js/api/widget_auth.php', objId, options, {}, {makeAuth: function(data) {
      if (data.session) {
        VK.Auth._loadState = 'loaded';
  ...
  VK.Widgets.Subscribe = function(objId, options, oid) {
    ...
    return VK.Widgets._constructor('http://vk.com/js/api/widget_subscribe.php', objId, options, params, {
      showBox: function(url, props) {
        var box = VK.Util.Box(VK.Widgets.showBoxUrl(options.base_domain, url), [], {
          proxy: function() {
            rpc.callMethod.apply(rpc, arguments);
  ...
  VK.Widgets.ContactUs = function(objId, options, oid) {
    ...
    return VK.Widgets._constructor('http://vk.com/js/api/widget_contactus.php', objId, options, params, {}, {
  ...
  VK.Widgets.Playlist = function(objId, ownerId, playlistId, hash, options) {
    ...
    return VK.Widgets._constructor('http://vk.com/js/api/widget_playlist.php', objId, options, params, {
      showBox: function(url, props) {
        var box = VK.Util.Box(VK.Widgets.showBoxUrl(options.base_domain, url), [], {
          proxy: function() {
            rpc.callMethod.apply(rpc, arguments);
  ...
  VK.Widgets.Ads = function(objId, options, paramsExtra) {
    ...
    return VK.Widgets._constructor('http://vk.com/js/api/ads_rotate.php', objId, options, params, funcs, defaults, onDone);
  ...
  VK.Widgets.AllowMessagesFromCommunity = function (objId, options, groupId) {
    ...
    return VK.Widgets._constructor('http://vk.com/js/api/widget_allow_messages_from_community.php', objId, options, params, {}, {
      startHeight: params.height,
      height: params.height
    }, function(o, i, r) {
      rpc = r;
  ...
  VK.Widgets.CommunityMessages = (function(CommunityMessages) {
    ...
    */
    CommunityMessages = function(objId, gid, options) {
      ...
      var chatRpc, chatIfr;
      var inited = 0, timers = {};
      instances[objId] = VK.Widgets._constructor('http://vk.com/js/api/widget_community_messages.php', objId, options, params, {
...
try{stManager.done('openapi.js'/*tpa=http://vk.com/js/api/api/openapi.js*/);}catch(e){}
